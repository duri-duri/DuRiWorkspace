...
# 모듈화된 시스템 import
from duri_modules import chatgpt_evaluator, duri_self_reflector, duri_chatgpt_discussion, conversation_store
...
async def duri_chatgpt_discussion_endpoint(discussion_request: Dict[str, Any]):
    ...
    try:
        ...
        if not duri_improvement_proposal or not chatgpt_evaluation:
            raise HTTPException(status_code=400, detail="duri_improvement_proposal과 chatgpt_evaluation이 필요합니다")
