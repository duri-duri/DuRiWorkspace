...
def test_learning_engine():
    ...
    test_cases = [
        ...
        {
            "content": "오늘 학습한 내용을 다시 생각해보니, 내가 어떤 부분을 잘 이해했고 어떤 부분이 어려웠는지 알 수 있었습니다. 다음에는 더 효율적으로 학습할 수 있을 것 같습니다.",  # noqa: E501
            "learning_type": "metacognitive",
            "context": {"reflection_level": "high", "self_awareness": "medium"},
        },
        {
            "content": "스스로 학습 계획을 세우고 목표를 설정했습니다. 독립적으로 공부하면서 새로운 지식을 습득할 수 있었습니다.",  # noqa: E501
            "learning_type": "autonomous",
            "context": {"autonomy_level": "high", "self_direction": "strong"},
        },
        {
            "content": "친구들과 함께 프로젝트를 진행하면서 서로의 아이디어를 공유하고 협력했습니다. 대화를 통해 새로운 관점을 배울 수 있었습니다.",  # noqa: E501
...
def test_individual_systems():
    ...
    family_result = family_system.process(
        "가족과 함께 영화를 보면서 아이의 반응을 관찰했습니다. 아이가 어떤 장면에서 웃고, 어떤 장면에서 집중하는지 알 수 있었습니다.",  # noqa: E501
        {"family_members": ["parent", "child"]},
    )
    ...
    social_result = social_system.process(
        "친구들과 함께 프로젝트를 진행하면서 서로의 아이디어를 공유하고 협력했습니다. 대화를 통해 새로운 관점을 배울 수 있었습니다.",  # noqa: E501
