...
def test_learning_engine():
    ...
    test_cases = [
        ...
        },
        {
            ...
            "context": {"family_members": ["parent", "child"], "activity": "movie_watching"}
        },
        {
...
def test_individual_systems():
    ...
    from DuRiCore.DuRiCore.modules.learning_engine import (
        TextLearningSystem, SubtitleLearningSystem, MetacognitiveLearningSystem,
        FamilyLearningSystem, AutonomousLearningController, SocialLearningSystem
    )
