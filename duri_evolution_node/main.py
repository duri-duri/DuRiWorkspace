...
async def learn_and_improve(request: EvolutionLearningRequest):
    ...
    try:
        ...
        # 3단계: DuRi-ChatGPT 논의
        discussion_result = await _discuss_improvements(user_input, duri_response, chatgpt_evaluation, duri_self_reflection)
        ...
        # 6단계: 자동 개선
        automatic_improvement = await _execute_automatic_improvement(user_input, duri_response, chatgpt_evaluation, duri_self_reflection)
        
        # 통합 점수 계산
        learning_score = _calculate_evolution_score(chatgpt_evaluation, duri_self_reflection, discussion_result,
                                                 autonomous_learning, realtime_learning, automatic_improvement)
        
        # 개선 제안 수집
        improvement_suggestions = _collect_improvement_suggestions(chatgpt_evaluation, duri_self_reflection, 
                                                                discussion_result, automatic_improvement)
...
async def _discuss_improvements(user_input: str, duri_response: str, chatgpt_evaluation: Dict[str, Any], duri_self_reflection: Dict[str, Any]) -> Dict[str, Any]:
    """DuRi-ChatGPT 논의"""
    try:
        # 논의 주제 식별
...
async def _execute_autonomous_learning(user_input: str, duri_response: str, brain_analysis: Dict[str, Any]) -> Dict[str, Any]:
    """자율 학습 실행"""
    try:
        # 학습 데이터 수집
...
async def _execute_realtime_learning(user_input: str, duri_response: str, brain_analysis: Dict[str, Any]) -> Dict[str, Any]:
    """실시간 학습 실행"""
    try:
        # 실시간 데이터 처리
...
async def _execute_automatic_improvement(user_input: str, duri_response: str, chatgpt_evaluation: Dict[str, Any], duri_self_reflection: Dict[str, Any]) -> Dict[str, Any]:
    """자동 개선 실행"""
    try:
        # 개선 영역 식별
...
def _calculate_evolution_score(chatgpt_evaluation: Dict[str, Any], duri_self_reflection: Dict[str, Any], 
                             discussion_result: Dict[str, Any], autonomous_learning: Dict[str, Any],
                             realtime_learning: Dict[str, Any], automatic_improvement: Dict[str, Any]) -> float:
    """Evolution 통합 점수 계산"""
    try:
        scores = [
...
def _collect_improvement_suggestions(chatgpt_evaluation: Dict[str, Any], duri_self_reflection: Dict[str, Any],
                                   discussion_result: Dict[str, Any], automatic_improvement: Dict[str, Any]) -> list:
    """개선 제안 수집"""
    suggestions = []
...
def _reach_agreements(discussion_topics: list, chatgpt_evaluation: Dict[str, Any], duri_self_reflection: Dict[str, Any]) -> list:
    """합의 도출"""
...
def _measure_improvement_effect(improvement_execution: Dict[str, Any]) -> Dict[str, Any]:
    """개선 효과 측정"""
