...
def create_app() -> FastAPI:
    ...
    app.include_router(self_evolution_router, tags=["self_evolution"])
    app.include_router(social_intelligence_router, tags=["social_intelligence"])
    app.include_router(creative_thinking_router, tags=["creative_thinking"])
