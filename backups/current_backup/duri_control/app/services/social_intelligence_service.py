...
class SocialIntelligenceService:
    ...
    def __init__(self, db_session: Session):
        ...
        self.emotion_weights = {
            ...
            "trust": 0.9, "surprise": 0.3, "anticipation": 0.6, "disgust": -0.4
        }
    ...
    def _analyze_user_input(self, user_input: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "analysis_confidence": self._calculate_analysis_confidence(intent, emotions)
            }
    ...
    def _detect_intent(self, text: str) -> Dict[str, Any]:
        ...
        try:
            intent_patterns = {
                "question": [r"\?", r"어떻게", r"무엇", r"언제", r"어디", r"왜", r"어떤"],
    ...
    def _analyze_importance(self, text: str, intent: Dict[str, Any], emotions: Dict[str, float]) -> float:
        """중요도 분석"""
        try:
            # 의도 기반 중요도
            intent_importance = {
            ...
            # 감정 기반 중요도
            emotion_importance = sum(self.emotion_weights.get(emotion, 0) * intensity 
            ...
            # 종합 중요도 계산
            importance = (
                intent_importance.get(intent.get("primary_intent", "general"), 0.5) * 0.4 +
    ...
    def _analyze_urgency(self, text: str, intent: Dict[str, Any], emotions: Dict[str, float]) -> float:
        """긴급성 분석"""
        try:
            ...
            emotion_urgency = sum(emotions.get(emotion, 0) for emotion in negative_emotions)
    ...
    def _analyze_collaboration_need(self, text: str, intent: Dict[str, Any]) -> Dict[str, Any]:
        """협력 필요성 분석"""
        try:
            collaboration_keywords = ["함께", "협력", "도움", "같이", "협업", "팀", "함께해"]
            collaboration_count = sum(1 for keyword in collaboration_keywords if keyword in text)
            ...
            collaboration_score = (
                ...
                intent_collaboration.get(intent.get("primary_intent", "general"), 0.3) * 0.4
            )
            
            return {
                "needed": bool(collaboration_score > 0.5),
                "score": float(collaboration_score),
                "type": "active" if collaboration_score > 0.7 else "passive" if collaboration_score > 0.4 else "none"
            }
    ...
    def _calculate_analysis_confidence(self, intent: Dict[str, Any], emotions: Dict[str, float]) -> float:
        """분석 신뢰도 계산"""
        try:
    ...
    def _analyze_conversation_context(self, input_analysis: Dict[str, Any]) -> Dict[str, Any]:
        """대화 맥락 분석"""
        try:
    ...
    def _analyze_emotional_state(self, input_analysis: Dict[str, Any]) -> Dict[str, Any]:
        """감정 상태 분석"""
        try:
            emotions = input_analysis.get("emotions", {})
            ...
            return {
                ...
                "emotional_state": emotional_state,
                "response_approach": response_approaches.get(primary_emotion, "neutral"),
    ...
    def _generate_appropriate_response(
        ...
        try:
            ...
            template = response_templates.get(primary_intent, {
            ...
            if emotional_state_info == "intense":
                template["tone"] = "calming" if primary_intent == "complaint" else "enthusiastic"
    ...
    def _update_conversation_context(self, user_input: Dict[str, Any], response: Dict[str, Any]):
        """대화 맥락 업데이트"""
        try:
            user_id = user_input.get("user_id", "unknown")
    ...
    def get_social_intelligence_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            conversation_stats = {
                ...
                "active_users": len([k for k, v in self.conversation_context.items() 
            ...
            return {
                ...
                "overall_social_score": np.mean(list(social_intelligence_scores.values()))
            }
