...
async def test_individual_phase2_modules():
    ...
    # 자가 반영 엔진 테스트
    print("\n🧠 자가 반영 엔진 테스트...")
    from duri_brain.reflection.self_reflection_engine import ReflectionType, SelfReflectionEngine
    ...
    test_reflections = [
        {
            "type": "judgment",
            "insights": ["판단에 편향이 감지되었습니다."],
            "action_items": ["객관성을 높여야 합니다."],
        },
        {
            "type": "emotion",
            "insights": ["긍정적인 감정 상태가 학습에 도움이 됩니다."],
            "action_items": ["감정을 유지하세요."],
        },
        {
            "type": "growth",
            "insights": ["충분한 경험을 쌓았습니다."],
            "action_items": ["다음 단계로 나아가세요."],
        },
    ]
