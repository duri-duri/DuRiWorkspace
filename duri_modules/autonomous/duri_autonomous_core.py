...
class DuRiAutonomousCore:
    ...
    async def execute_autonomous_learning_cycle(self, 
                                              conversation_context: Dict[str, Any]) -> AutonomousLearningCycle:
        """완전한 자율 학습 사이클 실행"""
        try:
    ...
    async def _apply_improvements(self, learning_result: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            unified_result = self.unified_improver.execute_comprehensive_improvement(
                improvement_context, 
                improvement_context.get("categories", {})
            )
    ...
    def _calculate_cycle_score(self, question_result: Dict[str, Any], 
    ...
    def _extract_insights(self, question_result: Dict[str, Any], 
                          learning_result: Dict[str, Any], 
                          improvement_result: Dict[str, Any]) -> List[str]:
        """인사이트 추출"""
        insights = []
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recent_insights": [cycle.insights for cycle in self.learning_history[-3:]] if self.learning_history else []
        }
