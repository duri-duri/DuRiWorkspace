...
class EmotionAnalyzer:
    ...
    def __init__(self):
        ...
        self.response_templates = {
            ...
            "focused": {
                "tone": "determined",
                "phrases": [
                    "좋습니다. 바로 본질에 집중해서 최단 경로로 진행하겠습니다.",
                    "정확히 파악했습니다. 체계적으로 접근하겠습니다.",
                ],
                "style": "precise",
            },
            "curious": {
    ...
    def _calculate_emotion_confidence(
        self, emotion_scores: Dict[str, float], structure_analysis: Dict[str, Any]
    ) -> float:
        """감정 분석 신뢰도 계산"""
        # 감정 점수의 분산 계산
    ...
    def generate_emotion_adaptive_response(
        self, user_emotion: str, context: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
        감정에 적응한 응답 생성
