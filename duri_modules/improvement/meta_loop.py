...
class MetaLoopSystem:
    ...
    def evaluate_improvement_effect(self, 
                                  original_response: str,
                                  improved_response: str,
                                  user_question: str,
                                  original_evaluation: Dict[str, Any]) -> Dict[str, Any]:
        """개선 효과 평가"""
        
        print(f"🔄 메타 루프: 개선 효과 평가 시작")
    ...
    def _analyze_improvement_effect(self, 
                                  original_eval: Dict[str, Any], 
                                  new_eval: Dict[str, Any]) -> Dict[str, Any]:
        """개선 효과 분석"""
    ...
    def get_meta_learning_statistics(self) -> Dict[str, Any]:
        ...
        successful_improvements = sum(
            1 for result in self.meta_evaluation_history
