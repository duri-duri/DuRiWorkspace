...
async def check_unified_learning_system():
    ...
    try:
        ...
        return {"system": "통합 학습 시스템", "status": "오류", "error": str(e)}
...
async def check_autonomous_learning_system():
    ...
    try:
        ...
        return {"system": "자율 학습 시스템", "status": "오류", "error": str(e)}
...
async def check_learning_loop_manager():
    ...
    try:
        ...
        return {"system": "학습 루프 매니저", "status": "오류", "error": str(e)}
...
async def check_realtime_learner():
    ...
    try:
        ...
        return {"system": "실시간 학습 시스템", "status": "오류", "error": str(e)}
