...
class IntegratedSystemManager:
    ...
    async def _save_to_memory(self, judgment_result: Dict, action_result: Dict, feedback_result: Dict):
        """결과를 메모리에 저장"""
        try:
            # 판단 결과 저장
    ...
    def _calculate_overall_score(self, judgment: Dict, action: Dict, feedback: Dict, performance: List) -> float:
        """전체 점수 계산"""
        try:
            # 각 시스템의 점수 추출
