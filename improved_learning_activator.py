    ...
    async def activate_unified_learning_system(self) -> Dict[str, Any]:
        ...
        for attempt in range(self.retry_count):
            try:
                ...
                return {"success": True, "session_id": session.id, "evolution_session_id": evolution_session.id}
        ...
        for attempt in range(self.retry_count):
            try:
                ...
                initial_strategy = {
                    ...
                    "intensity": "moderate",
                    "focus_areas": ["general", "problem_solving", "creativity", "ethics"],
        ...
        for attempt in range(self.retry_count):
            try:
                ...
                if realtime_started:
                    ...
                    if attempt == self.retry_count - 1:
                        return {"success": False, "error": "실시간 학습이 시작되지 않음"}
                    await asyncio.sleep(2)
