...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('learning_monitor.log'),
...
class LearningSystemMonitor:
    ...
    def get_learning_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            autonomous_status = {
                ...
                "continuous_learner_active": hasattr(self.autonomous_core, 'continuous_learner') and 
                                          self.autonomous_core.continuous_learner.is_active if hasattr(self.autonomous_core, 'continuous_learner') else False,
                "realtime_learner_active": hasattr(self.autonomous_core, 'realtime_learner') and 
                                         self.autonomous_core.realtime_learner.is_active if hasattr(self.autonomous_core, 'realtime_learner') else False
            }
            ...
            return {
                ...
                "last_analysis_time": self.auto_retrospector.last_analysis_time.isoformat() if self.auto_retrospector.last_analysis_time else None
            }
        except Exception as e:
            ...
            return {
                ...
                "autonomous_status": {"is_active": False, "continuous_learner_active": False, "realtime_learner_active": False},
    ...
    def print_status_dashboard(self, system_metrics: Dict[str, Any], learning_metrics: Dict[str, Any], alerts: List[str]):
        """상태 대시보드 출력"""
        print("\n" + "="*80)
        ...
        print(f"  메모리 사용률: {system_metrics['memory_usage']:.1f}% (사용 가능: {system_metrics['memory_available']:.1f}GB)")
