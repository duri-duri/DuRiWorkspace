...
# 로깅 설정
logging.basicConfig(
    level=logging.WARNING,  # WARNING 레벨로 설정하여 로그 줄이기
...
async def minimal_test():
    """최소한의 기능만 테스트"""
    print("🧪 DuRi 사회적 지능 시스템 최소 테스트 시작")
