...
class PerformanceAlertManager:
    ...
    async def add_alert_rule(self, rule_name: str, metric_name: str, condition: str,
                           threshold: float, alert_level: AlertLevel,
    ...
    async def _is_in_cooldown(self, rule_id: str) -> bool:
        ...
        try:
            ...
            recent_alerts = [a for a in self.alert_history 
                           ...
                           a.timestamp > datetime.now() - rule.cooldown_period]
