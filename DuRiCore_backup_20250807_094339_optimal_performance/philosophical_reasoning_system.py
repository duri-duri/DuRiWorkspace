...
class KantianReasoning:
    ...
    def _construct_kantian_premises(self, action: str, universalization_test: Dict, 
                                   humanity_test: Dict) -> List[PhilosophicalPremise]:
        """칸트적 전제 구성"""
        premises = []
        
        # 보편적 원칙 전제
        premises.append(PhilosophicalPremise(
    ...
    def _derive_kantian_conclusion(self, action: str, universalization_test: Dict, 
                                  humanity_test: Dict) -> str:
        """칸트적 결론 도출"""
...
class UtilitarianReasoning:
    ...
    def _construct_utilitarian_steps(self, action: str, premises: List[PhilosophicalPremise], 
                                   utility_calculation: Dict) -> List[LogicalStep]:
        """공리주의 논리적 단계 구성"""
        steps = []
...
class MultiPerspectiveAnalysis:
    ...
    def _integrate_perspectives(self, kantian: PhilosophicalArgument, 
                               utilitarian: PhilosophicalArgument) -> Dict[str, Any]:
        """관점 통합"""
        integration = {
    ...
    def _find_consensus(self, kantian: PhilosophicalArgument, 
                       utilitarian: PhilosophicalArgument) -> List[str]:
        """합의점 찾기"""
        consensus = []
        
        # 두 관점 모두 허용하는 경우
        if ("허용" in kantian.final_conclusion and 
            "허용" in utilitarian.final_conclusion):
            consensus.append("두 관점 모두 해당 행위를 허용함")
        
        # 두 관점 모두 금지하는 경우
        elif ("허용되지 않" in kantian.final_conclusion and 
              "허용되지 않" in utilitarian.final_conclusion):
            consensus.append("두 관점 모두 해당 행위를 금지함")
        
        return consensus
    
    def _identify_conflicts(self, kantian: PhilosophicalArgument, 
                          utilitarian: PhilosophicalArgument) -> List[str]:
        """충돌점 식별"""
        conflicts = []
    ...
    def _generate_recommendation(self, kantian: PhilosophicalArgument, 
                               utilitarian: PhilosophicalArgument) -> str:
        """통합 권고사항 생성"""
