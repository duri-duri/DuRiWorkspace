...
async def health_check():
    ...
    try:
        ...
        try:
            ...
            engines_status["emotion_engine"] = {"status": "unhealthy", "error": str(e)}
        ...
        try:
            ...
            engines_status["learning_engine"] = {"status": "unhealthy", "error": str(e)}

        # 윤리 판단 엔진 상태 확인
        try:
            ethical_engine = EthicalReasoningEngine()
            ethical_result = ethical_engine.analyze_ethical_dilemma(
                situation="기본 윤리 테스트", context={"complexity": "low"}
            )
            ...
            engines_status["ethical_engine"] = {"status": "unhealthy", "error": str(e)}
    ...
    try:
        engines_info = {
            ...
            "learning_engine": {
                ...
                "endpoints": [
                    "/api/v1/learning/process",
                    "/api/v1/learning/stats",
                    "/api/v1/learning/batch-process",
                ],
            },
            "ethical_engine": {
                "name": "윤리 판단 엔진",
                ...
                "endpoints": [
                    "/api/v1/ethical/analyze",
                    "/api/v1/ethical/stats",
                    "/api/v1/ethical/batch-analyze",
                ],
            },
            "evolution_engine": {
                "name": "자기 진화 엔진",
...
async def get_version_info():
    ...
    try:
        ...
        return {"error": str(e), "message": "버전 정보 조회 중 오류가 발생했습니다."}
