...
class CLARIONIntegrationTest:
    ...
    async def test_clarion_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # 검증
            assert clarion_result.learning_type in [LearningType.EXPLICIT, LearningType.IMPLICIT, LearningType.HYBRID], "학습 유형이 올바르지 않음"
            assert clarion_result.reinforcement_type in [ReinforcementType.POSITIVE, ReinforcementType.NEGATIVE, ReinforcementType.NEUTRAL], "강화 유형이 올바르지 않음"
