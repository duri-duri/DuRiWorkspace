...
class SentimentAnalyzer:
    ...
    def _analyze_text_sentiment(self, text: str) -> Dict[str, Any]:
        """텍스트 감정 분석"""
        # 간단한 규칙 기반 감정 분석
        positive_words = ["좋다", "훌륭하다", "감사하다", "행복하다", "성공", "완료", "성공적"]
...
class KeywordExtractor:
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        # 불용어 제거
        stop_words = {"이", "가", "을", "를", "의", "에", "로", "와", "과", "도", "는", "이", "다", "니다", "습니다"}
...
class ContextAnalyzer:
    ...
    def _analyze_conversation_context(self, user_input: str, duri_response: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "score": context_score,
            "keywords_found": [kw for kw in context_keywords if kw in user_input.lower() or kw in duri_response.lower()]
        }
...
class EthicalJudge:
    ...
    def _suggest_ethical_improvements(self, ethical_issues: List[str], ethical_appropriateness: Dict[str, Any]) -> List[str]:
        """윤리적 개선 제안"""
        improvements = []
...
class CreativeGenerator:
    ...
    def _analyze_creative_patterns(self, duri_response: str) -> List[str]:
        ...
        # 창의적 패턴 키워드
        creative_keywords = ["혁신", "창의", "새로운", "독창", "발명", "개발", "구현", "설계"]
    ...
    def _identify_innovative_approaches(self, duri_response: str) -> List[str]:
        ...
        # 혁신적 접근법 키워드
        innovative_keywords = ["분산", "자율", "학습", "진화", "자동화", "최적화", "통합"]
    ...
    def _suggest_creative_improvements(self, creative_patterns: List[str], innovative_approaches: List[str]) -> List[str]:
        """창의적 개선 제안"""
        improvements = []
