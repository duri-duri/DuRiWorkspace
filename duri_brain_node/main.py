...
async def analyze_conversation(request: BrainAnalysisRequest):
    ...
    try:
        ...
        # 통합 점수 계산
        analysis_score = _calculate_brain_score(meaning_analysis, context_analysis, emotion_analysis, 
                                             memory_retrieval, ethical_judgment, creative_insights)
...
async def _analyze_meaning(user_input: str, duri_response: str, ai_analysis: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "relevance_score": keyword_extraction.get("relevance_score", _calculate_relevance(user_keywords, response_keywords))
        }
...
async def _generate_creative_insights(user_input: str, duri_response: str, memory_retrieval: Dict[str, Any]) -> Dict[str, Any]:
    """창의적 통찰 생성"""
    try:
        # 창의적 패턴 분석
...
def _calculate_brain_score(meaning_analysis: Dict[str, Any], context_analysis: Dict[str, Any], 
                         emotion_analysis: Dict[str, Any], memory_retrieval: Dict[str, Any],
                         ethical_judgment: Dict[str, Any], creative_insights: Dict[str, Any]) -> float:
    """Brain 통합 점수 계산"""
    try:
        scores = [
...
def _calculate_context_score(conversation_context: Dict[str, Any], topic_consistency: float, temporal_context: Dict[str, Any]) -> float:
    """컨텍스트 점수 계산"""
