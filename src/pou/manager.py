...
class PoUManager:
    ...
    def _simulate_metrics(self, domain: str) -> Dict[str, float]:
        """도메인별 메트릭 시뮬레이션"""
        base_metrics = {
            "medical": {"latency": 1200, "accuracy": 0.85, "explainability": 0.78, "failure_rate": 0.02},
            "rehab": {"latency": 1100, "accuracy": 0.88, "explainability": 0.82, "failure_rate": 0.015},
            "coding": {"latency": 1000, "accuracy": 0.90, "explainability": 0.85, "failure_rate": 0.01}
        }
