...
async def test_async_functionality():
    ...
    try:
        from DuRiCore.monitoring.performance_monitoring import MetricCollector, MetricType
        from DuRiCore.monitoring.performance_monitoring import PerformanceAnalyzer
        from DuRiCore.monitoring.alert_system import PerformanceAlertManager, AlertLevel, AlertChannel
