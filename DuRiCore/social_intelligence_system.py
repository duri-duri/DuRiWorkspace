...
try:
    ...
    from ethical_judgment_system import EthicalJudgmentSystem  # noqa: F401
    from inner_thinking_system import InnerThinkingSystem, InternalMotivation, ThoughtDepth  # noqa: F401
    from integrated_evolution_system import DuRiIntegratedEvolutionSystem  # noqa: F401
    from integrated_thinking_system import IntegratedThinkingSystem  # noqa: F401
    from intuitive_thinking_system import IntuitiveThinkingSystem  # noqa: F401
    from meta_cognition_system import MetaCognitionSystem  # noqa: F401
    from phase_omega_integration import DuRiPhaseOmega, PhaseOmegaResult  # noqa: F401
    from self_directed_learning_system import SelfDirectedLearningSystem  # noqa: F401
...
class SocialIntelligenceSystem(BaseModule):
    ...
    async def understand_social_context(self, context_data: Dict[str, Any]) -> SocialContext:
        ...
        try:
            ...
            logger.info(
                f"사회적 맥락 이해 완료: {context_type.value} - {relationship_type.value} (처리시간: {processing_time:.3f}초)"  # noqa: E501
            )
