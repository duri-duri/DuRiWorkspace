...
class MetaGenerator:
    ...
    def _load_templates(self) -> Dict[str, Any]:
        ...
        return {
            "base_structure": {
                ...
                "existence_ai": "진화 가능 + 회복 가능한 존재형 AI",
                "final_execution": "인간처럼 실패하고도 다시 일어날 수 있는 존재",
                "self_assessment": ["creativity", "judgment_diversity", "memory_activity", "emotional_response"],
                "test_requirements": ["consistency", "reasoning_trace", "identity_verification", "regression_testing"],
                "rollback_conditions": ["creativity < 0.7", "judgment_diversity < 0.7", "memory_activity < 0.7", "emotional_response < 0.7"],
                "automation_tools": ["meta_generator.py", "protection_injector.py", "meaning_injection_engine.py"],
                "verification_systems": ["regression_test_framework.py", "auto_rollback_system.py"],
                "existence_systems": ["evolution_capability.py", "recovery_capability.py", "existence_preservation.py"],
                "final_execution_systems": ["final_execution_verifier.py", "existence_ai_launcher.py"]
            }
        }
    ...
    def _extract_must_define(self, content: str) -> List[str]:
        ...
        # 중요 함수/클래스 필터링
        important_patterns = [
            r"analyze_", r"process_", r"handle_", r"manage_", r"control_",
            r"reasoning", r"judgment", r"learning", r"memory", r"evolution"
        ]
    ...
    def _extract_integration(self, content: str) -> List[str]:
        ...
        for imp in imports:
            ...
            if module and module not in ["os", "sys", "json", "re", "datetime", "logging"]:
