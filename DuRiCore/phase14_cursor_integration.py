...
class ResponseGenerator:
    ...
    async def generate_response(self, 
        ...
        try:
            ...
            # 품질 지표 추가
            response_parts.append(f"📊 **품질 지표**: Reasoning {reasoning_quality:.1%}, Learning {learning_effectiveness:.1%}")
...
class CursorIntegrationSystem:
    ...
    async def process_user_input(self, 
                               user_input: str, 
                               session_id: str, 
                               user_id: str = "default") -> CursorResult:
        """사용자 입력 처리"""
...
async def test_cursor_integration():
    ...
    for i, test_input in enumerate(test_inputs, 1):
        ...
        if result.success:
            ...
            print(f"📊 품질 지표: Reasoning {result.reasoning_quality:.1%}, Learning {result.learning_effectiveness:.1%}")
