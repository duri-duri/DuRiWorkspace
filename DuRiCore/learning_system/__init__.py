...
from .core.knowledge_evolution import (
    EvolutionSession,
    EvolutionType,
    KnowledgeEvolution,
...
from .core.learning_optimization import (
...
# Monitoring 모듈
from .monitoring.learning_monitor import (
    LearningEvent,
    LearningMetrics,
...
from .strategies.meta_cognition import (
...
# Strategies 모듈
from .strategies.self_directed_learning import (
    CuriosityTrigger,
    LearningActivity,
    LearningGoal,
    LearningOutcome,
