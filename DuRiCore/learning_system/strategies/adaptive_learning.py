...
class AdaptiveLearningStrategy:
    ...
    async def _execute_learning(self, model: LearningModel, learning_type: LearningType, 
    ...
    async def _execute_adaptation(self, system_instance: Any, adaptation_type: AdaptationType,
