...
class IntuitiveThinkingSystem:
    ...
    async def _make_rapid_judgments(
        self, situation: Dict[str, Any], patterns: List[IntuitivePattern]
    ...
    async def _make_pattern_based_judgments(
        self, situation: Dict[str, Any], patterns: List[IntuitivePattern]
    ) -> List[IntuitiveJudgment]:
        """패턴 기반 빠른 판단"""
        judgments = []
    ...
    async def _generate_intuitive_insights(
        self,
        situation: Dict[str, Any],
    ...
    async def _apply_synthetic_thinking(
        self,
        situation: Dict[str, Any],
        patterns: List[IntuitivePattern],
    ...
    async def get_intuitive_thinking_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_confidence": await self._calculate_average_confidence(
                ...
                self.intuitive_judgments,
                self.intuitive_insights,
            ),
            "pattern_distribution": self._get_pattern_distribution(),
            "confidence_distribution": self._get_confidence_distribution(),
            "recent_insights": (
                [i.insight for i in self.intuitive_insights[-3:]] if self.intuitive_insights else []
            ),
        }
