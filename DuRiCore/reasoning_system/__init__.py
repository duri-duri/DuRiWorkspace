...
from .consistency.integration_evaluator import IntegrationAssessment, IntegrationEvaluator
from .consistency.knowledge_conflict import ConflictResolutionStrategy, KnowledgeConflict, KnowledgeConflictResolver

# Consistency 모듈
from .consistency.logical_connectivity import LogicalConnection, LogicalConnectionType, LogicalConnectivityValidator

# Data structures
from .data_structures import *  # noqa: F403

# Efficiency 모듈
from .efficiency.dynamic_resource_allocator import DynamicResourceAllocator, ResourceAllocation, ResourceType
from .efficiency.learning_strategy_optimizer import LearningOptimization, LearningStrategy, LearningStrategyOptimizer
...
# Integration 모듈
from .integration.conflict_detection import ConflictDetectionSystem, ConflictType, IntegrationConflict
from .integration.priority_system import IntegrationPriority, IntegrationPriorityItem, IntegrationPrioritySystem
from .integration.resolution_algorithm import ResolutionAlgorithm, ResolutionMethod
from .integration.success_monitoring import IntegrationMonitor, IntegrationSuccess, SuccessMonitoringSystem
...
# Reasoning Engine 모듈
from .reasoning_engine.inference_engine import InferenceContext, InferenceEngine, InferenceResult, InferenceType
from .reasoning_engine.logic_processor import LogicalChain, LogicalRule, LogicAnalysis, LogicProcessor, LogicType
