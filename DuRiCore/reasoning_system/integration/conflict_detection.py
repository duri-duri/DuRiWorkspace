...
class ConflictDetectionSystem:
    ...
    async def _check_value_conflict(self, element1: Dict[str, Any], element2: Dict[str, Any]) -> Optional[IntegrationConflict]:
        """값 충돌 확인"""
    ...
    async def _check_type_conflict(self, element1: Dict[str, Any], element2: Dict[str, Any]) -> Optional[IntegrationConflict]:
        """유형 충돌 확인"""
        common_keys = set(element1.keys()) & set(element2.keys())
    ...
    async def _check_structure_conflict(self, element1: Dict[str, Any], element2: Dict[str, Any]) -> Optional[IntegrationConflict]:
        """구조 충돌 확인"""
        # 구조적 차이 확인
