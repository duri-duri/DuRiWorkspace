...
class DecisionMaker:
    ...
    def _calculate_confidence(self, options: List[DecisionOption], selected_option: DecisionOption) -> float:
        """신뢰도 계산"""
        try:
            if not options:
                return 0.0
    ...
    def _calculate_intuitive_confidence(self, options: List[DecisionOption], selected_option: DecisionOption) -> float:
        """직관적 신뢰도 계산"""
        try:
            if not options:
                return 0.0
    ...
    def _calculate_emotional_confidence(self, options: List[DecisionOption], selected_option: DecisionOption) -> float:
        """감정적 신뢰도 계산"""
        try:
            if not options:
                return 0.0
    ...
    def _calculate_adaptive_confidence(self, options: List[DecisionOption], selected_option: DecisionOption) -> float:
        """적응적 신뢰도 계산"""
        try:
            if not options:
                return 0.0
    ...
    def _calculate_strategic_confidence(self, options: List[DecisionOption], selected_option: DecisionOption) -> float:
        """전략적 신뢰도 계산"""
        try:
            if not options:
                return 0.0
