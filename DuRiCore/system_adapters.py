...
# 모듈 레지스트리 시스템 import
try:
    from module_registry import BaseModule, ModuleMeta, ModulePriority
...
class JudgmentSystemAdapter(SystemAdapter):
    ...
    async def execute(self, context: Dict[str, Any]) -> Any:
        ...
        return {"status": "no_judgment_method", "message": "판단 시스템에 judge 메서드가 없습니다"}
...
class ActionSystemAdapter(SystemAdapter):
    ...
    async def execute(self, context: Dict[str, Any]) -> Any:
        ...
        return {"status": "no_action_method", "message": "행동 시스템에 act 메서드가 없습니다"}
...
class FeedbackSystemAdapter(SystemAdapter):
    ...
    async def execute(self, context: Dict[str, Any]) -> Any:
        ...
        return {"status": "no_feedback_method", "message": "피드백 시스템에 feedback 메서드가 없습니다"}
...
class MemorySystemAdapter(SystemAdapter):
    ...
    async def execute(self, context: Dict[str, Any]) -> Any:
        ...
        return {"status": "no_memory_method", "message": "메모리 시스템에 store 메서드가 없습니다"}
...
class SocialIntelligenceSystemAdapter(SystemAdapter):
    ...
    async def execute(self, context: Dict[str, Any]) -> Any:
        ...
        return {"status": "no_social_method", "message": "사회적 지능 시스템에 process_social_interaction 메서드가 없습니다"}
