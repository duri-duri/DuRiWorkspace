...
class InternalConflictDetector:
    ...
    def _initialize_ethical_principles(self) -> List[Dict[str, Any]]:
        """윤리적 원칙 초기화"""
        return [
            {"name": "autonomy", "description": "자율성 존중", "weight": 0.9},
            {"name": "beneficence", "description": "이익 증진", "weight": 0.8},
            {"name": "non_maleficence", "description": "해악 방지", "weight": 0.9},
            {"name": "justice", "description": "공정성", "weight": 0.8},
        ]
    ...
    async def _check_ethical_conflict(
        self,
        principle1: Dict[str, Any],
