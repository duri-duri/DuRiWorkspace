...
import numpy as np
from integrated_social_intelligence_system import \
    IntegratedSocialIntelligenceSystem
# 기존 시스템들 import
...
class EmotionAnalyzer:
    ...
    async def analyze_emotion(self, text: str, context: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        # 주요 감정 결정
        primary_emotion = (
            max(emotion_scores.items(), key=lambda x: x[1])[0] if emotion_scores else "중립"
        )
