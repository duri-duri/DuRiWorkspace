...
class BehaviorTracer:
    ...
    async def create_full_cycle_trace(
        self,
        cycle_id: str,
        memory_trace: MemoryTrace,
        judgment_trace: JudgmentTrace,
        ...
        try:
            ...
            # 전체 성공 여부 판단
            overall_success = (
                memory_trace.trace_metadata.status == TraceStatus.COMPLETED
                and judgment_trace.trace_metadata.status == TraceStatus.COMPLETED
                and action_trace.trace_metadata.status == TraceStatus.COMPLETED
                and action_trace.success
            )
