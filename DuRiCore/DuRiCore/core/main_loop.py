...
# 모듈 임포트
from ..modules.emotion_engine import EmotionEngine, EmotionalAnalysis
from ..modules.self_evolution import SelfEvolutionEngine, EvolutionResult
...
class MainLoop:
    ...
    async def _analyze_emotion(self, input_data: InputData) -> EmotionalAnalysis:
        ...
        try:
            ...
            return EmotionalAnalysis(
                ...
                confidence=0.0,
                context_fit=0.0,
                emotion_reason_balance={"balance_type": "neutral", "recommendation": "관찰 필요"},
    ...
    async def _check_and_evolve(self) -> Optional[EvolutionResult]:
        ...
        try:
            ...
            if (last_evolution is None or 
                (current_time - last_evolution).total_seconds() > 3600):
