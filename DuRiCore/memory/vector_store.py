...
class VectorMemoryStore:
    ...
    def _get_most_accessed_memories(self, limit: int) -> List[Dict[str, Any]]:
        ...
        return [
            {"id": m.id, "content": m.content[:50], "access_count": m.accessed_count} for m in sorted_memories[:limit]
        ]
    ...
    def _get_most_important_memories(self, limit: int) -> List[Dict[str, Any]]:
        ...
        return [{"id": m.id, "content": m.content[:50], "importance": m.importance} for m in sorted_memories[:limit]]
