...
class LIDAAttentionSystem:
    ...
    def _update_priority_queue(self):
        ...
        try:
            self.priority_queue = sorted(
                ...
                key=lambda x: float(x.attention_score) if isinstance(x.attention_score, (int, float)) else 0.0,
                reverse=True
            )
        except Exception as e:
    ...
    async def focus_on_task(self, task_id: str) -> Dict[str, Any]:
        ...
        self.attention_state.cognitive_load = min(1.0, 
            self.attention_state.cognitive_load + cognitive_load_increase)
    ...
    async def make_human_like_judgment(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        current_accuracy = min(1.0, base_accuracy + attention_bonus + cognitive_bonus + 
                             emotional_bonus + focus_bonus)
        ...
        try:
            ...
            self.performance_metrics['average_judgment_time'] = total_time / len(self.judgment_history)
        except Exception as e:
    ...
    def _generate_alternatives(self, context: Dict[str, Any], judgment_type: JudgmentType) -> List[str]:
    ...
    def _generate_context_based_alternatives(self, context: Dict[str, Any], judgment_type: JudgmentType) -> List[str]:
        """컨텍스트 기반 동적 대안 생성"""
        alternatives = []
    ...
    def get_performance_report(self) -> Dict[str, Any]:
        ...
        accuracy_improvement = (self.performance_metrics['accuracy_rate'] - self.baseline_accuracy) * 100
        ...
        return {
            ...
            'improvement_status': '✅ 달성' if accuracy_improvement >= target_improvement else '🔄 진행 중',
            ...
            'judgment_types': {jt.value: len([j for j in self.judgment_history if j.judgment_type == jt]) 
    ...
    async def process_attention(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'priority_level': self.attention_state.priority_level.value if hasattr(self.attention_state, 'priority_level') else 'medium'
            }
        except Exception as e:
    ...
    def _calculate_attention_score(self, context: Dict[str, Any]) -> float:
        ...
        try:
            ...
            complexity_keywords = ['problem', 'stakeholders', 'constraints', 'opportunities', 'risks']
    ...
    async def update_motivation_from_experience(self, experience: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if 'performance' in experience:
                await self.intrinsic_motivation.update_achievement_metrics(experience['performance'])
