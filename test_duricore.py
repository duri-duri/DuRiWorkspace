...
from DuRiCore.DuRiCore.core.main_loop import MainLoop, InputData
...
async def test_integration():
    ...
    print(f"\n결과 분석:")
    print(f"  - 감정: {result['emotional_analysis'].primary_emotion} (강도: {result['emotional_analysis'].intensity:.2f})")
    print(f"  - 판단: {result['judgment'].decision}")
