...
# 1) 내부 모듈
from tools.db import with_tx, upsert_canonical_bt, insert_answer_capsule, append_audit
from tools.fusion import crdt_merge, MonotoneLogit
...
def main():
    ...
    payload = {
        "mode":"external",
        "core":{"values":{"name_pub":core_val}, "pii_fields":["name_priv","email_priv"]},
        "output": fused_val
    }
