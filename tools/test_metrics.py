...
from duri_core.core.metrics import observe_phase, maybe_expose_metrics_port, start_demo_load
...
def serve_metrics(port: int, demo_load: bool = False, interval: float = 0.2, min_s: float = 0.05, max_s: float = 0.25):
    """메트릭 서버 모드 (프로세스 유지)"""
