...
core = load_set("CORE"); ext = load_set("EXTENDED"); full = load_set("FULL")
j_ce = jaccard(core, ext); j_ef = jaccard(ext, full)
...
if j_ce < th_ce or j_ef < th_ef:
    print("THRESHOLD VIOLATION"); sys.exit(2)
