...
def calculate_metrics(logs: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    # 에러율 계산
    error_count = sum(1 for log in task_logs 
                     if log.get("metrics", {}).get("error_count", 0) > 0)
...
def main():
    ...
    parser.add_argument("--output", default="slo_sla_dashboard_v1/metrics.json",
