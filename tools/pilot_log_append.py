...
DOMAIN_ALIASES = {
    "medical": "medical", "medicine": "medical", "med": "medical",
    "rehab": "rehab", "rehabilitation": "rehab",
    "coding": "coding", "developer": "coding", "code": "coding"
}
...
def generate_pilot_log_entry(domain: str, user_id: str, session_id: str, 
                           event_type: str, canary: bool = False) -> Dict[str, Any]:
...
def generate_session_logs(domain: str, num_sessions: int = 10, 
                         canary_percentage: float = 0.1) -> None:
    ...
    for session in range(num_sessions):
        ...
        # 세션 시작
        append_log_entry(log_file, generate_pilot_log_entry(
...
def main():
    ...
    parser.add_argument("--domain", 
                       choices=["medical", "med", "medicine", "rehab", "rehabilitation", "coding", "code", "developer"],
                       required=True, help="PoU domain (supports aliases)")
    parser.add_argument("--sessions", type=int, default=10, 
                       help="Number of sessions to generate")
    parser.add_argument("--canary", type=float, default=0.1, 
                       help="Canary percentage (0.0 to 1.0)")
