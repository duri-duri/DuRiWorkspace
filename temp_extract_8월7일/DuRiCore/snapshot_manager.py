...
class SnapshotManager:
    ...
    def save_snapshot(self, name: str, data: Dict[str, Any], description: str = "", tags: List[str] = None) -> bool:
        """스냅샷 저장"""
        try:
            # 스냅샷 데이터 생성
...
def save_system_snapshot(name: str, system_data: Dict[str, Any], description: str = "", tags: List[str] = None) -> bool:
    """시스템 스냅샷 저장 (편의 함수)"""
