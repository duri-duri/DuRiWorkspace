...
class DuRiStateRestorer:
    ...
    def verify_restored_state(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"✅ 복원 상태 검증 완료: {successful_systems}/{total_systems} 시스템 정상")
...
if __name__ == "__main__":
    ...
    if restore_result['success']:
        ...
        print(f"📊 시스템 검증: {verification_result['successful_systems']}/{verification_result['total_systems']}")
    else:
