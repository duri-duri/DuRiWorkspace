...
async def test_async_optimization_system():
    ...
    try:
        ...
        # 비동기 최적화 시스템 임포트
        from async_optimization_system import async_optimization_system, TaskPriority, OptimizationStrategy
        ...
        # 작업 제출
        task_id_1 = await async_optimization_system.submit_task("테스트 작업 1", test_task_1(), TaskPriority.HIGH)
        task_id_2 = await async_optimization_system.submit_task("테스트 작업 2", test_task_2(), TaskPriority.NORMAL)
        task_id_3 = await async_optimization_system.submit_task("테스트 작업 3", test_task_3(), TaskPriority.LOW)
...
async def test_memory_optimization_system():
    ...
    try:
        ...
        # 메모리 최적화 시스템 임포트
        from memory_optimization_system import memory_optimization_system, MemoryOptimizationType
...
async def test_integrated_performance_optimization():
    ...
    try:
        ...
        integrated_results = {
            ...
            "overall_status": "completed" if all("error" not in result for result in results.values()) else "partial_failure"
        }
