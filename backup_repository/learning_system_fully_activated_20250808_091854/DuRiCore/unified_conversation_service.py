...
class UnifiedConversationService:
    ...
    async def start_conversation(self, family_member_id: str, family_member_name: str, 
                               relationship: str, family_context: Dict[str, Any] = None) -> ConversationSession:
        """대화 세션 시작"""
        try:
    ...
    async def process_message(self, session_id: str, speaker_id: str, speaker_name: str, 
                            message: str, context: Dict[str, Any] = None) -> ConversationResponse:
        """메시지 처리 및 응답 생성"""
        try:
            # 메시지 생성
