...
try:
    ...
    from creative_thinking_system import CreativeThinkingSystem, CreativeIdea
...
class MetaCognitionSystem:
    ...
    async def think_with_meta_cognition(self, context: Dict[str, Any]) -> MetaCognitionResult:
        ...
        try:
            ...
            logger.info(f"=== 메타 인식 사고 완료 - 소요시간: {duration:.2f}초, 사고과정: {len(thinking_processes)}개 ===")
            return result
    ...
    async def _monitor_inner_thinking(self, context: Dict[str, Any]) -> ThinkingProcess:
        ...
        if self.inner_thinking:
            ...
            process = ThinkingProcess(
                ...
                end_time=end_time,
                duration=duration,
                quality_score=inner_result.self_reflection_score if hasattr(inner_result, 'self_reflection_score') else 0.5,
    ...
    async def _monitor_emotional_thinking(self, context: Dict[str, Any]) -> ThinkingProcess:
        ...
        if self.emotional_thinking:
            ...
            process = ThinkingProcess(
                ...
                end_time=end_time,
                duration=duration,
                quality_score=emotional_result.emotional_accuracy if hasattr(emotional_result, 'emotional_accuracy') else 0.5,
                meta_cognition_level=MetaCognitionLevel.ENHANCED,
                context={"emotional_thinking_result": emotional_result.__dict__ if hasattr(emotional_result, '__dict__') else {}}
            )
            return process
    ...
    async def _monitor_intuitive_thinking(self, context: Dict[str, Any]) -> ThinkingProcess:
        ...
        if self.intuitive_thinking:
            ...
            process = ThinkingProcess(
                ...
                end_time=end_time,
                duration=duration,
                quality_score=intuitive_result.average_confidence if hasattr(intuitive_result, 'average_confidence') else 0.5,
                meta_cognition_level=MetaCognitionLevel.ENHANCED,
                context={"intuitive_thinking_result": intuitive_result.__dict__ if hasattr(intuitive_result, '__dict__') else {}}
            )
            return process
    ...
    async def _monitor_creative_thinking(self, context: Dict[str, Any]) -> ThinkingProcess:
        ...
        if self.creative_thinking:
            ...
            process = ThinkingProcess(
                ...
                end_time=end_time,
                duration=duration,
                quality_score=creative_result.average_creativity_level if hasattr(creative_result, 'average_creativity_level') else 0.5,
                meta_cognition_level=MetaCognitionLevel.ENHANCED,
                context={"creative_thinking_result": creative_result.__dict__ if hasattr(creative_result, '__dict__') else {}}
            )
            return process
    ...
    async def _create_observation_reflection(self, context: Dict[str, Any], 
    ...
    async def _create_analysis_reflection(self, context: Dict[str, Any], 
                                        thinking_processes: List[ThinkingProcess]) -> SelfReflection:
        """분석적 성찰 생성"""
    ...
    async def _create_evaluation_reflection(self, context: Dict[str, Any], 
                                          thinking_processes: List[ThinkingProcess]) -> SelfReflection:
        """평가적 성찰 생성"""
    ...
    async def _create_synthesis_reflection(self, context: Dict[str, Any], 
                                         thinking_processes: List[ThinkingProcess]) -> SelfReflection:
        """종합적 성찰 생성"""
    ...
    async def _create_integration_reflection(self, context: Dict[str, Any], 
                                           thinking_processes: List[ThinkingProcess]) -> SelfReflection:
        """통합적 성찰 생성"""
    ...
    async def _extract_insights_from_assessments(self, quality_assessments: List[ThinkingQualityAssessment]) -> List[MetaCognitionInsight]:
        ...
        for assessment in quality_assessments:
            if assessment.overall_quality in [ThinkingQuality.GOOD, ThinkingQuality.EXCELLENT]:
                insight = MetaCognitionInsight(
    ...
    async def _apply_meta_cognition_improvements(self, thinking_processes: List[ThinkingProcess],
                                               self_reflections: List[SelfReflection],
                                               quality_assessments: List[ThinkingQualityAssessment]) -> List[Dict[str, Any]]:
        """메타 인식 기반 개선 적용"""
        improvements = []
    ...
    async def _improve_quality_assessments(self, quality_assessments: List[ThinkingQualityAssessment]) -> List[Dict[str, Any]]:
        """품질 평가 개선"""
        improvements = []
        
        for assessment in quality_assessments:
            if assessment.overall_quality in [ThinkingQuality.POOR, ThinkingQuality.FAIR]:
                improvement = {
...
async def test_meta_cognition_system():
    ...
    context2 = {"challenge": "창의적 문제 해결", "complexity": "높음", "innovation": "필요"}
