...
class JudgmentTraceLogger:
    ...
    def record_judgment_trace(self, context: str, judgment: str, reasoning: str, 
                            outcome: str, confidence_level: float = 0.0, 
                            tags: List[str] = None) -> JudgmentTrace:
        """
        판단 과정을 기록합니다.
    ...
    def get_traces_by_confidence_range(self, min_confidence: float = 0.0, 
                                     max_confidence: float = 1.0) -> List[JudgmentTrace]:
