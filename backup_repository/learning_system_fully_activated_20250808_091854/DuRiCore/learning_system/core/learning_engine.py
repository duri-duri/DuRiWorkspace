...
class LearningEngine:
    ...
    async def create_learning_session(self, process_type: LearningProcessType, 
    ...
    async def create_learning_process(self, session_id: str, process_type: LearningProcessType,
