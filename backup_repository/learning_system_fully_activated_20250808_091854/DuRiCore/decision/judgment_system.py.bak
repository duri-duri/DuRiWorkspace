...
class JudgmentSystem:
    ...
    async def judge(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                import os
                sys.path.append(os.path.dirname(os.path.abspath(__file__)))
                from memory.judgment_trace_store import record_judgment_trace, get_reasoning_trace
    ...
    async def analyze_situation(self, input_data: Dict[str, Any], 
                              context: Dict[str, Any]) -> SituationAnalysis:
        """상황 분석"""
        try:
    ...
    async def make_decision(self, situation_analysis: SituationAnalysis,
                           available_actions: List[str],
                           constraints: Dict[str, Any]) -> DecisionResult:
        """의사결정 수행"""
        try:
            start_time = datetime.now()
    ...
    async def evaluate_judgment_quality(self, situation_analysis: SituationAnalysis,
                                      decision_result: DecisionResult,
                                      outcome: Dict[str, Any]) -> JudgmentQuality:
        """판단 품질 평가"""
        try:
            # 1. 정확도 평가
    ...
    async def _calculate_analysis_confidence(self, data_analysis: Dict[str, Any],
                                           context_elements: List[str],
                                           situation_pattern: Dict[str, Any]) -> float:
        """분석 신뢰도 계산"""
        try:
            confidence = 0.5
    ...
    async def _rule_based_decision(self, situation_analysis: SituationAnalysis,
                                  available_actions: List[str],
    ...
    async def _ml_based_decision(self, situation_analysis: SituationAnalysis,
                                available_actions: List[str],
                                constraints: Dict[str, Any]) -> Dict[str, Any]:
        """머신러닝 기반 의사결정"""
        try:
    ...
    async def _ethical_review(self, rule_decision: Dict[str, Any],
                             ml_decision: Dict[str, Any],
                             situation_analysis: SituationAnalysis) -> Dict[str, Any]:
        """윤리적 검토"""
        try:
            ethical_score = 0.5
    ...
    async def _hybrid_decision(self, rule_decision: Dict[str, Any],
                              ml_decision: Dict[str, Any],
                              ethical_review: Dict[str, Any]) -> Dict[str, Any]:
        """하이브리드 의사결정"""
        try:
    ...
    async def _generate_alternatives(self, situation_analysis: SituationAnalysis,
    ...
    async def _assess_decision_risk(self, decision: Dict[str, Any],
                                   situation_analysis: SituationAnalysis) -> Dict[str, float]:
        """의사결정 위험 평가"""
        try:
            risk_assessment = {}
    ...
    async def _evaluate_accuracy(self, decision_result: DecisionResult,
    ...
    async def _evaluate_consistency(self, decision_result: DecisionResult,
    ...
    async def _evaluate_ethical_quality(self, decision_result: DecisionResult,
                                       outcome: Dict[str, Any]) -> float:
        """윤리적 품질 평가"""
        try:
    ...
    async def _evaluate_efficiency(self, decision_result: DecisionResult,
                                  outcome: Dict[str, Any]) -> float:
        """효율성 평가"""
        try:
            efficiency = 0.5
    ...
    async def _generate_feedback(self, accuracy_score: float, consistency_score: float,
                                ethical_score: float, efficiency_score: float) -> List[str]:
        """피드백 생성"""
        try:
            feedback = []
    ...
    async def _generate_improvement_suggestions(self, accuracy_score: float,
                                              consistency_score: float,
                                              ethical_score: float,
    ...
    def _extract_keywords_from_content(self, content: str) -> List[str]:
        ...
        # 중요 키워드 패턴
        important_keywords = [
            "error", "problem", "issue", "fail", "broken", "fix", "solve",
            "learn", "study", "understand", "explain", "help", "guide",
            "urgent", "important", "critical", "emergency", "immediate",
            "success", "complete", "finish", "done", "working", "good",
    ...
    def _analyze_sentiment(self, content: str) -> str:
        ...
        positive_words = ["good", "great", "excellent", "success", "working", "complete", "done"]
    ...
    def _real_make_decision(self, situation_analysis: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            complexity_score = situation_analysis.get("complexity_score", 0.5)
            ...
            return {
                ...
                "risk_assessment": {"overall_risk": 0.5, "decision_risk": 0.4, "execution_risk": 0.3},
                "ethical_score": 0.5
            }
