...
class SelfAssessmentSystem:
    ...
    def __init__(self):
        ...
        self.assessment_criteria = {
            "autonomy": {
                "weight": 0.3,
                "indicators": ["self_directed_learning", "independent_decision_making", "goal_setting"]
            },
            "learning_efficiency": {
                "weight": 0.25,
                "indicators": ["learning_speed", "knowledge_retention", "adaptation_rate"]
            },
            "problem_solving": {
                "weight": 0.25,
                "indicators": ["complexity_handling", "creative_solutions", "error_recovery"]
            },
            "evolution_capability": {
                "weight": 0.2,
                "indicators": ["self_improvement", "meta_learning", "evolution_awareness"]
            }
        }
    ...
    def _calculate_assessment_confidence(self, performance_data: Dict[str, Any]) -> float:
        ...
        try:
            ...
            available_indicators = sum(1 for indicator in data_quality_indicators 
    ...
    def _analyze_evolution_progress(self) -> Dict[str, Any]:
        ...
        try:
            ...
            area_progress = {
                ...
                "learning_efficiency": self._calculate_progress_rate([a.learning_efficiency_score for a in recent_assessments]),
                "problem_solving": self._calculate_progress_rate([a.problem_solving_score for a in recent_assessments]),
                "evolution_capability": self._calculate_progress_rate([a.evolution_capability_score for a in recent_assessments])
            }
