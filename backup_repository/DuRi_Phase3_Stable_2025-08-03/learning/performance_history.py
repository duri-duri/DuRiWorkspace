...
class PerformanceHistory:
    ...
    def _calculate_trends(self, start_time: datetime, end_time: datetime) -> List[PerformanceTrend]:
        """특정 기간의 성능 경향을 계산합니다."""
        trends = []
    ...
    def _calculate_metric_trend(self, metric_name: str, start_time: datetime, end_time: datetime) -> Optional[PerformanceTrend]:
        """특정 지표의 경향을 계산합니다."""
        try:
            conn = sqlite3.connect(self.db_path)
            cursor = conn.cursor()
