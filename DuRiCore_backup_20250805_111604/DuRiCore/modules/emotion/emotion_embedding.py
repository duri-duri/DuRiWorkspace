...
class NLPEmotionEmbedding:
    ...
    def __init__(self):
        ...
        self.emotion_keywords = {
            EmotionCategory.JOY: [
                "기쁘다", "행복하다", "즐겁다", "신나다", "좋다", "만족하다",
                "웃다", "미소", "환호", "축하", "성공", "승리", "희망"
            ],
            EmotionCategory.SADNESS: [
                "슬프다", "우울하다", "속상하다", "실망하다", "외롭다", "그립다",
                "눈물", "한숨", "절망", "상실", "이별", "고독", "비통"
            ],
            EmotionCategory.ANGER: [
                "화나다", "분노하다", "짜증나다", "열받다", "격분하다", "욱하다",
                "폭발", "참을수없다", "억울하다", "원망", "적대", "복수"
            ],
            EmotionCategory.FEAR: [
                "무섭다", "겁나다", "두렵다", "불안하다", "걱정하다", "공포",
                "떨다", "긴장", "불안", "공포", "위험", "위협", "불안정"
            ],
            EmotionCategory.SURPRISE: [
                "놀라다", "깜짝", "충격", "예상밖", "어이없다", "헉",
                "어쩌지", "어떻게", "갑자기", "뜻밖", "예상외"
            ],
            EmotionCategory.DISGUST: [
                "역겹다", "싫다", "혐오", "구역질", "더럽다", "지저분",
                "불쾌", "악취", "더러움", "혐오감", "싫어하다"
            ],
            EmotionCategory.LOVE: [
                "사랑하다", "좋아하다", "그립다", "그리워하다", "보고싶다",
                "애정", "따뜻함", "포근함", "안전함", "신뢰", "믿음"
            ],
            EmotionCategory.CONTEMPT: [
                "경멸", "무시", "하찮다", "별거아니다", "실망", "실망하다",
                "무가치", "쓸모없다", "허무", "허탈"
            ],
            EmotionCategory.ANTICIPATION: [
                "기대하다", "설레다", "긴장하다", "준비하다", "계획하다",
                "미래", "희망", "꿈", "목표", "동경", "열망"
            ]
        }
    ...
    def _calculate_emotion_intensity(self, text: str, detected_emotions: Dict[EmotionCategory, List[str]]) -> float:
        """감정 강도 계산"""
    ...
    def _determine_primary_emotion(self, detected_emotions: Dict[EmotionCategory, List[str]], intensity: float) -> EmotionCategory:
        """주요 감정 결정"""
        if not detected_emotions:
    ...
    def _get_secondary_emotions(self, detected_emotions: Dict[EmotionCategory, List[str]], primary: EmotionCategory) -> List[EmotionCategory]:
        """보조 감정들 추출"""
        secondary = []
    ...
    def _calculate_confidence(self, detected_emotions: Dict[EmotionCategory, List[str]], intensity: float) -> float:
        """감정 분석 신뢰도 계산"""
        if not detected_emotions:
            return 0.1
    ...
    def _calculate_sentiment_score(self, text: str, primary_emotion: EmotionCategory, intensity: float) -> float:
        """감정 점수 계산 (-1.0 ~ 1.0)"""
        # 감정별 기본 점수
        emotion_scores = {
    ...
    def _extract_emotional_keywords(self, text: str, detected_emotions: Dict[EmotionCategory, List[str]]) -> List[str]:
        """감정 키워드 추출"""
        keywords = []
