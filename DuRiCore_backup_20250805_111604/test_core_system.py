...
from DuRiCore.modules.emotion.emotion_embedding import NLPEmotionEmbedding, EmotionCategory
from DuRiCore.memory.vector_store import VectorMemoryStore
from DuRiCore.modules.judgment.self_critique import SelfCritiqueSystem, CritiqueLevel, BiasType
    ...
    test_memories = [
        {
            ...
            "emotion": {"primary_emotion": "joy", "intensity": 0.8, "sentiment_score": 0.7},
            "context": {"topic": "work", "intent": "celebration"}
        },
        {
            "content": "친구와 다퉈서 속상하다. 화해하고 싶다.",
            "emotion": {"primary_emotion": "sadness", "intensity": 0.6, "sentiment_score": -0.5},
            "context": {"topic": "relationship", "intent": "conflict"}
        },
        {
            "content": "새로운 기술을 배우고 있다. 어렵지만 재미있다.",
            "emotion": {"primary_emotion": "anticipation", "intensity": 0.7, "sentiment_score": 0.6},
