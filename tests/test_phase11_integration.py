...
class TestPhase11Integration:
    ...
    async def test_enhanced_judgment_phase(self):
        ...
        with patch.object(
            ...
            return_value={"phase": "judgment", "status": "completed"},
        ):
    ...
    async def test_enhanced_action_phase(self):
        ...
        with patch.object(
            orchestrator,
            "_execute_action_phase",
            return_value={"phase": "action", "status": "completed"},
        ):
    ...
    async def test_enhanced_feedback_phase(self):
        ...
        with patch.object(
            orchestrator,
            "_execute_feedback_phase",
            return_value={"phase": "feedback", "status": "completed"},
        ):
    ...
    async def test_inner_reflection(self):
        ...
        with patch.object(
            orchestrator.inner_thinking,
            "think_deeply",
            return_value={"reflection": "test reflection"},
        ):
    ...
    async def test_external_learning(self):
        ...
        with patch.object(
            orchestrator.unified_learning,
            "process_learning",
            return_value={"learning": "test learning"},
        ):
