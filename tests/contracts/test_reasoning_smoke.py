...
try:
    ...
    try:
        # 백업 경로 1
        from DuRiCore.reasoning_engine.core.logical_reasoning_engine import LogicalReasoningEngine as ReasoningEngine
    except Exception:
        # 백업 경로 2
        from duri_core.reasoning_engine.core.logical_reasoning_engine import LogicalReasoningEngine as ReasoningEngine
