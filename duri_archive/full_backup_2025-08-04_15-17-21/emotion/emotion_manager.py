...
from .emotion_filter import EmotionAnalysis, EnhancedEmotionFilter
...
class EmotionManager:
    ...
    def analyze_emotion(
        ...
        pattern_analysis = self.emotion_analyzer.analyze_emotion_patterns(
            emotion_history
        )
    ...
    def get_emotion_for_judgment(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "regulation_capability": current_emotion.meta_cognition.get(
                "regulation_capability", 1.0
            ),
            "emotion_awareness": current_emotion.meta_cognition.get(
