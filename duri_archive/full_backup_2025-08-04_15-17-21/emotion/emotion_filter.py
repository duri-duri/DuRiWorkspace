...
class EnhancedEmotionFilter:
    ...
    def _analyze_emotion_intensity(
        ...
        intensity_count = sum(
            1 for indicator in intensity_indicators if indicator in text
        )
    ...
    def get_emotion_weight(self) -> float:
        ...
        bias_penalty = (
            0.2 if self.current_emotion.bias_detected != JudgmentBias.NONE else 0.0
        )
    ...
    def get_processing_recommendations(self) -> Dict[str, Any]:
        ...
        high_intensity = self.current_emotion.intensity in [
