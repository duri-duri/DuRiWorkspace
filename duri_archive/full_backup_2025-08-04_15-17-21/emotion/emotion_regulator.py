...
class EmotionRegulator:
    ...
    def _select_regulation_strategy(self, emotion_analysis: EmotionAnalysis) -> str:
        ...
        # 기본 전략
        base_strategy = self.regulation_strategies.get(emotion, {}).get(
            "strategy", "default"
        )
    ...
    def _apply_regulation_strategy(
        self, emotion_analysis: EmotionAnalysis, strategy: str
    ) -> Dict[str, Any]:
        """조절 전략 적용"""
        strategies = {
    ...
    def _apply_immediate_reassurance(
        self, emotion_analysis: EmotionAnalysis
    ) -> Dict[str, Any]:
        """즉시 안심"""
        return {
    ...
    def _apply_intensive_regulation(
        self, emotion_analysis: EmotionAnalysis
    ) -> Dict[str, Any]:
        """집중 조절"""
        return {
    ...
    def get_regulation_effectiveness(self) -> float:
        ...
        total_effectiveness = sum(
            r["result"]["effectiveness"] for r in self.regulation_history
        )
