...
from .emotion_filter import EmotionAnalysis, EmotionCategory, EmotionIntensity
...
class EmotionAnalyzer:
    ...
    def _calculate_emotion_stability(
        self, emotions: List[EmotionCategory], intensities: List[float]
    ) -> float:
        """감정 안정성 계산"""
        if len(emotions) < 2:
            return 1.0
        ...
        stability = (
            ...
            - (intensity_variance / len(intensities))
        )
