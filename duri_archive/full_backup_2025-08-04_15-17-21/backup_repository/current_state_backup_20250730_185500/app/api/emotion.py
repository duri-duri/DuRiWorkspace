    ...
    try:
        ...
        balance_type = (
            ...
            if balance_score < 0.2
                ...
                "emotion_dominant"
                if emotional_influence > rational_influence
                else "reason_dominant"
            )
        )
        ...
        raise HTTPException(
            status_code=500, detail=f"감정-이성 균형 분석 실패: {str(e)}"
        )
        ...
        return {
            ...
            "empathetic_response": {
                ...
                "intensity_level": (
                    ...
                    else "medium" if user_intensity > 0.4 else "low"
                ),
                "empathy_score": 0.9,
            },
        }
...
async def get_emotional_intelligence_stats():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"감정 지능 통계 조회 실패: {str(e)}"
        )
