...
class UnifiedManager:
    ...
    def process_complete_cycle(self, user_input: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # 4. 자가 반영 및 성과 측정
            reflection_entry = self._create_reflection_entry(
                emotion_result, growth_result
            )
            ...
            # 6. 자아 피드백 생성
            self_feedback = self._generate_self_feedback(
                emotion_result, growth_result, reflection_entry, performance_score
            )
            ...
            return {"error": str(e), "cycle_status": "error"}
    ...
    def _create_reflection_entry(
        self, emotion_result: Dict[str, Any], growth_result: Dict[str, Any]
    ) -> Dict[str, Any]:
        """자가 반영 일지 생성"""
    ...
    def _measure_performance(
        ...
        # 판단 결과 (기본값)
        judgment_result = {"overall_bias_score": 0.0}
    ...
    def _generate_auto_quest(
        self, reflection_entry: Dict[str, Any], growth_result: Dict[str, Any]
    ) -> Dict[str, Any]:
        """자율 퀘스트 생성"""
        # 성찰 데이터
        reflection_data = {
    ...
    def _generate_recommendations(
        ...
        if quest_progress.get("progress", 0.0) < 0.5:
            recommendations.append(
                "퀘스트 진행도를 높이기 위해 더 많은 노력을 기울이세요."
            )
    ...
    def _prepare_next_cycle(
        self, self_feedback: Dict[str, Any], auto_quest: Dict[str, Any]
    ) -> Dict[str, Any]:
        """다음 사이클 준비"""
        return {
