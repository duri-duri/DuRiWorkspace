...
class UnifiedReflectionSystem:
    ...
    def reflect(
        ...
        try:
            ...
            logger.info(
                f"✅ 통합 반성 완료: {event_type} - 신뢰도: {unified_result.confidence:.3f}"
            )
    ...
    def _perform_learning_reflection(
    ...
    def _perform_response_reflection(
        self, event_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """답변 품질 기반 반성 수행"""
    ...
    def _perform_insight_reflection(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": self.insight_reflector.analyze_recent_sessions().get(
                "success_rate", 0.0
            ),
        }

    def _perform_consciousness_reflection(
        self, event_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """의식적 반성 수행"""
        ...
        return {
            ...
            "consciousness_level": self.consciousness_system.current_capabilities.get(
                "self_reflection", 0.6
            ),
        }
    ...
    def _convert_to_unified_format(
        ...
        # 이슈 식별
        issue_identified = self._extract_issue_identified(
            original_result, reflection_type
        )
    ...
    def _extract_issue_identified(
        self, original_result: Dict[str, Any], reflection_type: ReflectionType
    ) -> str:
        """이슈 식별 추출"""
    ...
    def _create_error_result(
        self, event_type: str, error_message: str
    ) -> UnifiedReflectionResult:
        """오류 결과 생성"""
        return UnifiedReflectionResult(
    ...
    def get_reflection_statistics(self) -> Dict[str, Any]:
        ...
        avg_confidence = (
            confidence_sum / total_reflections if total_reflections > 0 else 0
        )
        ...
        return {
            ...
            "applied_count": len(
                [r for r in self.unified_reflection_history if r.applied]
            ),
        }
