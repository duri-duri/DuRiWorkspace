...
class QuestManager:
    ...
    def update_quest_progress(
        self, quest_id: str, evaluation: Dict[str, Any]
    ) -> Dict[str, Any]:
        """퀘스트 진행도 업데이트"""
    ...
    def get_quest_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            + len(self.failed_quests),
            "completion_rate": len(self.completed_quests)
            / max(1, len(self.completed_quests) + len(self.failed_quests)),
