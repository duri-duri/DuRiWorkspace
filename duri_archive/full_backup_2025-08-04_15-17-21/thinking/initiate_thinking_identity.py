...
class ThinkingSeedGenerator:
    ...
    def add_internal_experience(self, experience: str):
        ...
        self.internal_experiences.append(
            {"experience": experience, "timestamp": datetime.now()}
        )

    def add_goal(self, goal: str):
        """목표 추가"""
        self.goals.append({"goal": goal, "timestamp": datetime.now()})

    def add_emotion(self, emotion: str):
        """감정 추가"""
        self.emotions.append({"emotion": emotion, "timestamp": datetime.now()})

    def add_value(self, value: str):
        """가치 추가"""
        self.values.append({"value": value, "timestamp": datetime.now()})
...
class AutonomousDecomposer:
    ...
    def decompose_problem(self, problem: str) -> List[str]:
        ...
        # 기본 사고 구조
        basic_structure = ["상황 분석", "가치 기준 설정", "대안 비교", "최종 판단"]
        ...
        self.generated_structures.append(
            {"problem": problem, "structure": structure, "timestamp": datetime.now()}
        )
...
class DecisionExplanationEngine:
    ...
    def generate_decision_explanation(
        self, decision: str, context: str, alternatives: List[str]
    ) -> str:
        """판단 설명 생성"""
...
class SelfEvaluationLoop:
    ...
    def evaluate_decision(
        self, decision: str, feedback: str, expected_outcome: str
    ) -> Dict[str, Any]:
        """판단 평가"""
    ...
    def _analyze_feedback_match(self, decision: str, feedback: str) -> float:
        ...
        match_score = len(decision_keywords.intersection(feedback_keywords)) / len(
            decision_keywords
        )
    ...
    def _apply_learning(self, decision: str, feedback: str, match_score: float) -> str:
        ...
        self.learning_applications.append(
            {"decision": decision, "learning": learning, "timestamp": datetime.now()}
        )
...
class ThinkingIdentitySystem:
    ...
    def initiate_thinking_process(self, external_problem: str = None) -> Dict[str, Any]:
        ...
        decision_log.judgment_id = (
            f"judgment_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
        )
    ...
    def evaluate_with_feedback(self, judgment_id: str, feedback: str) -> Dict[str, Any]:
        ...
        evaluation = self.evaluation_loop.evaluate_decision(
            target_log.decision_explanation, feedback, "예상 결과"
        )
    ...
    def get_thinking_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_learning_applications": len(
                self.evaluation_loop.learning_applications
            ),
        }
