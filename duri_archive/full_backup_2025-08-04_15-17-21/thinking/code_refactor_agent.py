...
class CodeRefactorAgent:
    ...
    def analyze_code_file(self, file_path: str) -> CodeAnalysis:
        ...
        try:
            ...
            logger.info(f"✅ 코드 분석 완료: {file_path} - 품질 점수 {quality_score:.3f}")
            return analysis
    ...
    def create_refactor_task(self, refactor_type: RefactorType, target_file: str, description: str, priority: int = 1) -> RefactorTask:
        """리팩토링 작업 생성"""
...
"""
    ...
    def generate_refactor_plan(self, analyses: List[CodeAnalysis]) -> List[RefactorTask]:
        """리팩토링 계획 생성"""
    ...
    def get_refactor_status(self) -> Dict[str, Any]:
        ...
        if total_tasks > 0:
            ...
            success_rate = successful_tasks / completed_tasks if completed_tasks > 0 else 0.0
        else:
            completion_rate = 0.0
            success_rate = 0.0
