...
class PreFamilyLearningDemo:
    ...
    def get_demo_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "current_status": {
                "has_current_session": self.learning_controller.current_session is not None,
                "current_session_id": self.learning_controller.current_session.session_id if self.learning_controller.current_session else None
            }
        }
