...
# 고급 뇌 기능 라우터 연결
app.include_router(
    self_evolution_router, prefix="/self-evolution", tags=["self_evolution"]
)
app.include_router(
    emotional_intelligence_router,
    prefix="/emotional-intelligence",
    tags=["emotional_intelligence"],
)
app.include_router(
    creative_thinking_router, prefix="/creative-thinking", tags=["creative_thinking"]
)
app.include_router(
    social_intelligence_router,
    prefix="/social-intelligence",
    tags=["social_intelligence"],
)
