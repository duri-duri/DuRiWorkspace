...
(ROOT/"clinic"/"ingest_index.json").write_text(json.dumps(report,ensure_ascii=False,indent=2),encoding="utf-8")
print("[OK] ingest -> clinic/ingest_index.json; derived texts:", len([x for x in index if x["extracted"]]))
